...
$id = $_GET['id'];
$id1 = $_GET['id1'];
$sql = mysqli_query($conn, "SELECT * FROM tb_sarana WHERE id_sarana = '$id1'");
    ...
    <div id="wrapper">
        ...
        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-50 mb-4">Realisasi Sarana</h1>
                            </div>
                            <form class="user" action="proses_realisasi_sarana.php?id=<?= $id ?>&id1=<?= $id1 ?>" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $max_query = mysqli_query($conn, "SELECT SUM(jumlah) FROM tb_sarana WHERE id_sarana='$id1'");
                                    $max_result = $max_query->fetch_array(MYSQLI_NUM);
                                    $max = $max_result[0];?>
                                    <input type="number" class="form-control form-control-user" id="jumlah" name="jumlah" min="0" max="<?= $max ?>">
                                </div>
                                <div class="form-group">
                                ...
                                if (isset($_POST['realisasi'])) {
                                    ...
                                    $harga_query = mysqli_query($conn, "SELECT harga FROM tb_sarana WHERE id_sarana='$id1'");
                                    ...
                                    $proses = mysqli_query($conn, "UPDATE tb_sarana SET jumlah = '$jumlahsekarang', subtotal = '$subtotal', bukti = '$gambar', tanggal_order = '$tanggal_order', link = '$link', status_order = 'Sudah', status_bayar = '$status_bayar' WHERE id_sarana = '$id1'");
                                    if ($proses) {
                                        echo "
                                        <script>
                                            alert('Data Berhasil Masuk!');
                                            window.location.href='realisasi_sarana.php?id=$id';
                                        </script>
                                        ";
                                    } else {
                                        echo "
