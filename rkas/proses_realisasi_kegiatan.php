...
$id = $_GET['id'];
$id1 = $_GET['id1'];
$sql = mysqli_query($conn, "SELECT * FROM tb_kegiatan WHERE id_kegiatan = '$id1'");
    ...
    <div id="wrapper">
        ...
        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-50 mb-4">Realisasi Kegiatan</h1>
                            </div>
                            <form class="user" action="proses_realisasi_kegiatan.php?id=<?= $id ?>&id1=<?= $id1 ?>" method="POST" enctype="multipart/form-data">
